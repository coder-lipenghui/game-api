...
/**
 * This is the model class for table "tab_vconin_rem".
 *
 * @property int $id
 * @property string $logtime 记录时间
 * @property string $playername 角色名
 * @property string $src 操作ID
 * @property string $addvc 移除元宝数
 * @property string $nowvc 剩余元宝数
 */
class TabVconinRem extends BaseApi
{
    /**
     * {@inheritdoc}
     */

...
/**
 * This is the model class for table "tab_vcoinbind_add".
 *
 * @property int $id
 * @property string $logtime 记录时间
 * @property string $playername 角色名
 * @property string $src 操作ID
 * @property string $addvc 获取绑定元宝数
 * @property string $nowvc 总共绑定元宝数
 */
class TabVcoinbindAdd extends BaseApi
{
    /**
     * {@inheritdoc}
     */

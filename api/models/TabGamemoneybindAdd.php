...
/**
 * This is the model class for table "tab_gamemoneybind_add".
 *
 * @property int $id
 * @property string $logtime 日志记录时间
 * @property string $playername 角色ID
 * @property string $src 操作ID
 * @property string $addvc 增加绑定金币数量
 * @property string $nowvc 角色总绑定金币数
 */
class TabGamemoneybindAdd extends BaseApi
{
    /**
     * {@inheritdoc}
     */
